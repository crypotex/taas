...
class ReservationTest(TestCase):
    ...
    def test_user_can_see_multiple_unpaid_reservations(self):
        ...
        self.assertEqual(len(response.context_data['reservation_list']), 3, _("All three reservations are shown"))
    ...
    def post_valid_reservation(self, start, end, field):
        ...
        self.assertEqual(done_reservations.count(), 1, _('No reservation made with valid data'))
