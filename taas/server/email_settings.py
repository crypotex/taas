...
USER_REGISTRATION_MESSAGE = _("""Dear %(username)s,
...
We received registration request for user with username %(username)s.
Please verify him.
...
USER_VERIFICATION_MESSAGE = _("""Dear %(username)s,
...
USER_DISABLED_MESSAGE = _("""Dear %(username)s,
